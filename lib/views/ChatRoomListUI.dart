...
class _ChatRoomListUIState extends State<ChatRoomListUI> with SingleTickerProviderStateMixin {
    ...
    return Hero(
      ...
      child: Material(
        child: ListTile(
          ...
          onTap: () async {
            // Pre-load role before navigation
  ...
  String _formatLastMessageTime(DateTime time) {
    ...
    if (messageDate == today) {
      ...
      return DateFormat('EEE').format(time); // Day name
    } else {
