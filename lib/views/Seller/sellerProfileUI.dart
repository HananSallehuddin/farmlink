...
class sellerProfileUI extends StatefulWidget {
  @override
  _sellerProfileUIState createState() => _sellerProfileUIState();
}

class _sellerProfileUIState extends State<sellerProfileUI> with AutomaticKeepAliveClientMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  width: double.infinity,
                  child: ElevatedButton(
                    onPressed: () => Get.toNamed('recyclePage'),
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Styles.primaryColor,
                      padding: EdgeInsets.symmetric(vertical: 16),
                      shape: RoundedRectangleBorder(
                ...
                SizedBox(
                  width: double.infinity,
                  child: ElevatedButton(
                    onPressed: () => Get.toNamed('ratingListSeller'),
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Styles.primaryColor,
                      padding: EdgeInsets.symmetric(vertical: 16),
                      shape: RoundedRectangleBorder(
      ...
      bottomNavigationBar: bottomNavigationBarSeller(currentRoute: '/editprofile'),
    );
  }
